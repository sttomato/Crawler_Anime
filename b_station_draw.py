# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 13:34:12 2017
...
def get_more(start, end):
    for i in range(start, end):
        print i
        url = 'https://api.vc.bilibili.com/link_draw/v1/doc/list?category=draw&type=2&page_size=20&page_num={}&tag=&source=normal'.format(i)        
